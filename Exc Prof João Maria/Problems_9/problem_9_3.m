% Finite square well - Numerov and shooting method
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% parameters:
V0 = 20.0;   % potential outside of well
a = 1.0;   % size of (half of) well
b = 4.0;   % where the wave function can already be considered zero
h = 0.001;   % (h = dx)
...
x_match = 0.7;   % could be any number between -1 and 1
